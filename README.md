...
La integración OAuth, la creación de carpeta/planilla, la lectura, la escritura, la edición, el renombrado, la duplicación, los filtros y el borrado fueron probados con una planilla de prueba; las diez corridas están documentadas en `corridas/`. La corrida 06 agrega el consumo real de tokens y su costo calculado; la corrida 07 agrega la comparación real de modelos; las corridas 08, 09 y 10 conservan entrada, salida anonimizada, fecha, modelo, estado HTTP y tokens reales. La cotización consultada es la más cercana disponible al momento de la carga en Binance P2P; no es una serie histórica exacta por fecha. El usuario puede corregirla en el formulario antes de guardar.
